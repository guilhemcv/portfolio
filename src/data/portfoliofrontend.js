...
const portfoliofrontend = [
  {
    ...
    description:
      "Reconstituer une landing-page pour une application mobile en full CSS",
  },
  {
    image: media,
    lien: "https://github.com/guilhemcv/social-media-tracking",
    description:
      "Reconstituer un dashboard des réseaux sociaux en full CSS",
  },
  {
    image: abonnement,
    lien: "https://github.com/guilhemcv/page-abonnement",
    description:
      "Reconstituer une page d'abonnement avec toggle 'tarif mensuel et annuel' en full CSS",
  },
  {
    image: boutique,
